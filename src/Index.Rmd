...
sfm2$varcor %>% kable(caption = "Random effects",
                            booktabs = TRUE, digits = 3)
```
...
```{r mixedcovvarcov, include = TRUE, echo = FALSE, message = FALSE, warning = FALSE}
sfm3$varcor %>% kable(caption = "Random effects",
                            booktabs = TRUE, digits = 3)
```
...
sfm6$coefficients %>% kable(caption = "Fixed effects for a model with random intercept and slope, including age and housing, dichotomized dependent variable",
                            booktabs = TRUE, digits = 3)
```

```{r mixeddicvarcov, include = TRUE, echo = FALSE, message = FALSE, warning = FALSE}
sfm6$varcor %>% kable(caption = "Random effects",
                            booktabs = TRUE, digits = 3)
```
